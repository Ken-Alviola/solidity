...
contract Property{
    // declaring state variables saved in contract's storage. Uses gas 
    ...
    // is execuated only once at contract's deployment
    ...
    // getter fuction, returns a state variables
    // a function declared 'view' does not alter the blockchain
    function getPrice() public view returns(uint){
        return price;
    }
    
    // setter function, sets a state variables
